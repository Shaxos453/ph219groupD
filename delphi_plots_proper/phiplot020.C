...
void phiplot020()
{
  ...
  //creating a canvas for the histogram of size 750px * 750px
  TCanvas *c1 = new TCanvas("c1", "Delta Phi distribution", 750, 750);
  ...
  delphi->SetTitle("|#Delta#phi| distribution for 0-20 class");
