void sumpT_transverse_020()
{
  TFile *f = new TFile("13TeV_CR0_RHoff.root"); //opens file 13TeV_CR0_RHoff.root
  TTree *tree = (TTree*)f->Get("pytree020"); //opens tree of multiplicity class 0-20
  ...
  final->SetTitle("Transverse region (0-20)");
  ...
  final->Draw("HIST");
  c2->SaveAs("spT_transverse_020.pdf");
}
