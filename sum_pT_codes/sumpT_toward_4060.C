void sumpT_toward_4060()
{
  TFile *f = new TFile("13TeV_CR0_RHoff.root"); //opens file 13TeV_CR0_RHoff.root
  TTree *tree = (TTree*)f->Get("pytree4060"); //opens tree of multiplicity class 40-60
  ...
  final->SetTitle("Toward region (40-60)");
