void sumpT_transverse_2040()
{
  TFile *f = new TFile("13TeV_CR0_RHoff.root"); //opens file 13TeV_CR0_RHoff.root
  TTree *tree = (TTree*)f->Get("pytree2040"); //opens tree of multiplicity class 0-20
  ...
  final->SetTitle("Transverse region (20-40)");
  ...
  final->Draw("HIST");
  c2->SaveAs("spT_transverse_2040.pdf");
}
